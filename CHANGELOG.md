...
- Added ``LocalController`` class which allows users to directly connect controller to bytroner-bot
...
- Default ``Camera`` class now uses ZMQ Camera.  This means you must run the ZMQ camera publisher to access the camera as before.  If you wish to use the old Camera class, do ```from bytroner-bot.camera.opencv_gst_camera import OpenCvGstCamera``` and ``camera = OpenCvGstCamera()``
...
[bytroner]: https://github.com/NVIDIA-AI-IOT/bytroner-bot/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/NVIDIA-AI-IOT/bytroner-bot/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/NVIDIA-AI-IOT/bytroner-bot/releases/tag/v0.3.0
